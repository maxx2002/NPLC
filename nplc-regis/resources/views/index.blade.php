...
<!-- <p>Khusus untuk kamu yang masih SMA! Ayo daftarkan teammu dalam
    lomba bergengsi yang diadakan setaiap tahun oleh Student Union
    Information and Multimedia Technology (IMT) Universitas Ciputra.
    Lomba ini cocok buat kamu yang ingin mencari keseruan sambil
    mengasah kemampuan coding atau menjawab soal-soal logika.
...
<h2>This Year’s NPLC</h2>
<h1>SISTEM PERMAINAN LOGIKA</h1>
<p>Tahun ini, NPLC terbagi menjadi 2 kategori yaitu kategori programing
    dan kategori logic.</p>
<p>Untuk mengikuti kategori programming, kalian harus menguasai salah
    satu dari bahasa Java, Pascal atau C++ serta menyelesaikan semua
    teka-teki dan game-game yang diberikan. Klik tombol dibawah ini
    untuk mendownload contoh-contoh soal.</p>
